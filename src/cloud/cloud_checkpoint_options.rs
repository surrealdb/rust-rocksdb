...
impl CloudCheckpointOptions {
    ...
    pub fn get_thread_count(&self) -> i32 {
        unsafe { ffi::rocksdb_cloud_checkpoint_options_get_thread_count(self.inner) as i32 }
    }
    ...
    pub fn get_flush_memtable(&self) -> bool {
        unsafe { ffi::rocksdb_cloud_checkpoint_options_get_flush_memtable(self.inner) != 0 }
    }
}
